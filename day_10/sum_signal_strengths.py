# Find the sum of the signal strengths on the following cycles: 20, 60, 100, 140, 180, 220
...
# Check the cycle and update the signal strength as needed
def check_cycle():
    global cycle, total_signal_strength

    if cycle in sum_cycles:
        total_signal_strength += cycle * x_reg
...
print("Signal strength: %d" % total_signal_strength)