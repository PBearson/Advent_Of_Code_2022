# Calculate the monkey business by counting the two most active monkeys inspect items over 10000 rounds. Multiply those numbers together. Worry levels are no longer divided by 3.
...
class Monkey:
    ...
    # Perform the operations on each item, mod the common divisor
    def perform_operations(self, divisor:int):
        for i in range(len(self.items)):
            ...
            # Keep worry levels down using common divisor
...
# Common divisor among all divisors (the operands used in the division tests)
commonDiv = 1
...
# Get the monkeys and run the 10000 rounds
initialize_monkeys()
run_rounds()
